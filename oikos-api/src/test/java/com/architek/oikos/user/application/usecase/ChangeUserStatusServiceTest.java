...
class ChangeUserStatusServiceTest {
    ...
    private ChangeUserStatusService newService() {
        return new ChangeUserStatusService(userRepository, contactDirectoryPort);
    }
    ...
    private void stubContact(User user) {
        when(contactDirectoryPort.getContactById(user.getContactId()))
                .thenReturn(new ContactDetails("Doe", "Jane", EmailVO.of("a@b.com"), null));
    }
