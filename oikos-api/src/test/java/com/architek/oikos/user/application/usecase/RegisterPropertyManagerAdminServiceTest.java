...
class RegisterPropertyManagerAdminServiceTest {
    ...
    private RegisterPropertyManagerAdminService newService() {
        return new RegisterPropertyManagerAdminService(userRepository, partyProvisioningPort, propertyProvisioningPort,
    ...
    @Test
    void registering_a_property_manager_admin_provisions_the_property_first_then_a_scoped_party_and_grants_the_role_through_it() {
        ...
        assertThat(userCaptor.getValue().getPropertyRoleGrants())
                .extracting("role").containsExactly(PropertyRole.PROPERTY_MANAGER_ADMIN);
