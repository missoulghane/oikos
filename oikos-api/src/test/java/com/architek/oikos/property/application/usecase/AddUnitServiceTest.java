...
class AddUnitServiceTest {
    ...
    private AddUnitService newService() {
        return new AddUnitService(unitRepository, buildingRepository);
    }
    ...
    void adding_a_unit_to_an_existing_building_persists_it() {
        ...
        newService().add(new AddUnitCommand(buildingId, "A12", UnitType.APARTMENT, new BigDecimal("150")));
    }
    ...
    void adding_a_unit_to_an_unknown_building_is_rejected() {
        ...
        assertThatThrownBy(() -> newService().add(new AddUnitCommand(buildingId, "A12", UnitType.APARTMENT, BigDecimal.TEN)))
