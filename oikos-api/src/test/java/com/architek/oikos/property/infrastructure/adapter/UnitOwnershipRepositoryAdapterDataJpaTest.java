...
class UnitOwnershipRepositoryAdapterDataJpaTest {
    ...
    void findAllByUnitId_returns_only_entries_for_that_unit() {
        UnitId unitId = UnitId.newId();
        adapter.save(UnitOwnership.create(UnitOwnershipId.newId(), unitId, EntityId.newId(), OwnershipShare.of(BigDecimal.TEN)));
        adapter.save(UnitOwnership.create(UnitOwnershipId.newId(), UnitId.newId(), EntityId.newId(), OwnershipShare.of(BigDecimal.ONE)));
