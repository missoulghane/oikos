...
public record PropertyView(PropertyId id, String name, String address, String city,
                           DuesCalculationMode duesCalculationMode, BigDecimal projectedBudget) {
    ...
    public static PropertyView from(Property property) {
        return new PropertyView(property.getId(), property.getName(), property.getAddress(),
                property.getCity().orElse(null), property.getDuesCalculationMode(),
