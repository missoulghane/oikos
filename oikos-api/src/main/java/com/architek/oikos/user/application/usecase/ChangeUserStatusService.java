...
public class ChangeUserStatusService implements ChangeUserStatusUseCase {
    ...
    public ChangeUserStatusService(UserRepository userRepository, ContactDirectoryPort contactDirectoryPort) {
    ...
    public UserView changeStatus(ChangeUserStatusCommand command) {
        ...
        return UserView.of(updated, contactDirectoryPort.getContactById(updated.getContactId()));
    }
}
