import { z } from 'zod';
import { registerUserSchema } from '@/features/identity/register/schemas/registerUserSchema';
...
export const registerPropertyAdminSchema = registerUserSchema.extend({
