        ...
        <Alert
          ...
          message={
            lastResult.skippedUnitIds.length === 0
              ...
              : `Appel généré : ${lastResult.chargedUnitIds.length} lot(s) facturé(s), ${lastResult.skippedUnitIds.length} lot(s) ignoré(s) (prix non configuré ou compte non provisionné).`
          }
        />
      )}
