      ...
      <div className="flex items-end gap-2">
        <div className="flex-1">
          ...
          <textarea
            ...
            autoFocus
            className="w-full resize-none rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-base text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-none focus:border-brand-300 focus:ring-3 focus:ring-brand-500/20 disabled:opacity-60"
            {...register('body')}
          />
